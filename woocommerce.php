...
<main>
    <div class="container">
        ...
        <section class="text-center">
            ...
            <!--Grid row-->
            <div class="row" >
                <div class="col-sm-3" style="float:left;height:100%;">
                    <h1>Looking For the Perfect Gift?</h1>
                    <p>Fill in the criteria below to find a gift</p>
            ...
            ?>
                <!--Grid column-->
                <div class="col-lg-4 col-md-6 col-6 mb-4" style="float:right;">
...
?>
                     <!--    <p>
                      ...
                      <!--  <a href="<?php echo get_permalink(wc_get_page_id( 'cart' ))  . "?add-to-cart=" .  get_the_ID() ; ?> " class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Add to cart">
                        ...
                        <!-- <a href="/flint-components/contact" class="btn btn-info btn-sm">Contact Us</a> -->
